/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from testing/testing_znan_inf.cpp, normal z -> d, Fri Jun  1 13:10:10 2018
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    // ----- isnan
    magma_assert_warn( ! std::isnan( MAGMA_D_REAL(a_a)   ), "! isnan( real(a_a)   )" );
    magma_assert_warn(   std::isnan( MAGMA_D_REAL(nan_a) ), "  isnan( real(nan_a) )" );
    magma_assert_warn( ! std::isnan( MAGMA_D_REAL(inf_a) ), "! isnan( real(inf_a) )" );

    // ----- isinf
    magma_assert_warn( ! std::isinf( MAGMA_D_REAL(a_a)   ), "! isinf( real(a_a)   )" );
    magma_assert_warn( ! std::isinf( MAGMA_D_REAL(nan_a) ), "! isinf( real(nan_a) )" );
    magma_assert_warn(   std::isinf( MAGMA_D_REAL(inf_a) ), "  isinf( real(inf_a) )" );
